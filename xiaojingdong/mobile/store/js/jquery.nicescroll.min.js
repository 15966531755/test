...
(function (e) {
    ...
    var z = window.MutationObserver || window.WebKitMutationObserver || !1, G = {
        zindex: "auto",
        cursoropacitymin: 0,
        cursoropacitymax: 1,
        cursorcolor: "#424242",
        ...
        this.delayed = function (c, b, f, e) {
            ...
            }; else if (!d || !d.tt)a.delaylist[c] = {last: h, tt: 0}, setTimeout(function () {
                b.call()
            }, 0)
        };
        ...
        this.init = function () {
            ...
            if (!a.ispage || !d.cantouch && !d.isieold && !d.isie9mobile) {
                ...
                a.ispage ? (f.css({
                    ...
                    top: "0px",
                    height: "100%"
                }), f.align ? f.css({right: "0px"}) : f.css({left: "0px"}), a.body.append(f), a.railh && (m.css({
                    position: "fixed",
                    left: "0px",
                    width: "100%"
                }), m.align ? m.css({bottom: "0px"}) : m.css({top: "0px"}), a.body.append(m))) : (a.ishwscroll ?
                    ("static" == a.win.css("position") && a.css(a.win, {position: "relative"}), c = "HTML" == a.win[0].nodeName ? a.body : a.win, a.zoom && (a.zoom.css({
                        position: "absolute",
                        top: 1,
                        right: 0,
                        ...
                        position: "absolute",
                        top: 0
                    }), f.align ? f.css({right: 0}) : f.css({left: 0}), c.append(f), m && (m.css({
                        position: "absolute",
                        left: 0,
                        bottom: 0
                    }), m.align ? m.css({bottom: 0}) : m.css({top: 0}), c.append(m))) : (a.isfixed = "fixed" == a.win.css("position"), c = a.isfixed ? "fixed" : "absolute", a.isfixed || (a.viewport = a.getViewport(a.win[0])),
        ...
        this.showCursor = function (c, b) {
            ...
            if (a.rail) {
                ...
                }) : a.cursorh.css({width: a.cursorwidth, left: a.scroll.x}), a.cursoractive = !0);
