...
<div class="main">
    <form method="post" action="">
        <div class="div1">
            ...
            <p>Access Key Secret：<input type="password" id="secretkey" name="hy_secretkey" style="width: 228px;" value='<?php echo $hy_secretkey ?>'/><p>
            ...
            <p style="color: #808080;">　　　　　③ 如需技术支持请联系：鸿宇科技 & Shadow QQ:10373458</p>
...
<div style="width: 100%;line-height: 35px;font-size: 12px;color: #585858;text-align: center;position:fixed;bottom:0;border-top: 1px solid #DCDCDC;"><a href="http://hongyuvip.com" target="_blank" style="text-decoration: none;color: #585858;">Copyright (c) 2015 - 2018 鸿宇科技 版权所有 盗版必究 </a></div>
</body>
</html>
